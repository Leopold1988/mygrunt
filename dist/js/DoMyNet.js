...
define('a', [], function(require, exports, module) {
  ...
  // 通过 require 引入依赖
  var $ = require('js/jquery-1.8.2-cmd.js');
  console.log($);
...
seajs.use("js/main");;// 加载模块 main，并在加载完成时，执行指定回调
seajs.use('js/app', function () {
...
;/*
 * 把一个匿名函数当做变量传入闭包，判断有无SeaJS提供的define方法。
 * 若有，则为CMD模块读取，返回$.noConflict(true)；
 * 若无，则为普通的脚本引入，执行原生的jquery代码。
 */
(function(factory) {
...
;(function(){
  var a = "abc";
})();;var b = 2;;window.alert(11);;var a = 1;